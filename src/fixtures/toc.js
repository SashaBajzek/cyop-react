...
let pages = {
  ...
  what_react: {
    ...
    photos: [{alt: 'React’s logo, three ellipses around a circle', photo: whatReact}],
    text: [
      ...
      {
        text: 'Component-based:  Components manage their own state with their logic written in JavaScript',
        link: null,
      },
  ...
  intro_presentation: {
    ...
    text: [
      ...
      {
        text: 'It has 3 themes & we are going to learn how to set them using React.',
        link: null,
      },
    ],
  ...
  intro_react_app: {
    ...
    text: [
      ...
      {
        text: 'Components take in props(data), manage their own state, and render the appropriate HTML to the page',
        link: null,
      },
      {
        text:
  ...
  no_rerender: {
    ...
    text: [
      {
        text: 'See the number in the top right: I created a counter for the header to track it rerendering.',
        link: null,
      },

      {
        text: 'The header takes in only 1 prop: theme.  The header rerenders each time the theme prop changes.',
        link: null,
      },
      {
        text:
      ...
      {
        text: 'Can also see this in the dev tools console: I added a console.log for each header rerender.',
        link: null,
      },
    ],
  ...
  console: {
    ...
    text: [
      ...
      {
        text: 'Change the theme. Now the header rerenders since it’s theme prop changed.',
        link: null,
      },
    ],
    title: 'Console check',
  ...
  first_component: {
    ...
    text: [
      ...
      {
        text: 'The second photo is what is rendered in the DOM as seen via devTools',
        link: null,
      },
      {
        text: 'The component takes in props and returns what React should render.  That part is written in JSX syntax.',
        link: null,
      },
    ],
  ...
  intro_jsx: {
    ...
    text: [
      ...
      {
        text: 'Differences from html:  className (class) and htmlFor (for) (reserved in JS)',
        link: null,
      },
    ],
  ...
  functional_components_example: {
    ...
    text: [
      {
        text: 'Here is a simplified version of the vote button from the voting pages.',
        link: null,
      },
      {
  ...
  class_components: {
    ...
    text: [
      ...
      {
        text: 'All class components need to have a render() method.  It will be called each time an update happens.',
        link: null,
      },
    ],
  ...
  event_handlers: {
    ...
    text: [
      ...
      {
        text: "This function updates the component's state using `this.setState`",
        link: null,
      },
      {
        text: 'When the state changes, the component is rerendered and that is how the text gets updated.',
        link: null,
      },
    ],
  ...
  lifecycle_methods: {
    ...
    title: 'Lifecycle Methods (http://projects.wojtekmaj.pl/react-lifecycle-methods-diagram/)',
  },
  choose_theme: {
  ...
  props: {
    ...
    text: [
      ...
      {
        text: 'Now the Header component can use the theme to update it’s CSS class',
        link: null,
      },
    ],
    title: 'Props!',
  ...
  prop_drilling: {
    ...
    text: [
      {
        text: 'Like pouring water, props trickle down the chains of parents and children',
        link: null,
      },
      {
        text:
      ...
      {
        text: 'You have other options!  React context or a state management library (like Redux or Mobx)',
        link: null,
      },
    ],
    title: 'Prop Drilling',
  ...
  context: {
    ...
    text: [
      ...
      {
        text: 'Using context, we can avoid passing props through intermediate elements.',
        link: null,
      },
      {
        text:
  ...
  context_provider: {
    ...
    text: [
      ...
      {
        text: 'This is the App component.  The constructor contains the SetTheme updater and the initial theme',
        link: null,
      },
      {
        text:
  ...
  context_consumer: {
    ...
    text: [
      ...
      {
        text: '`setTheme` from the ThemeContext gets called and updates the theme based on the form selection.',
        link: null,
      },
      {
        text: '`theme` from the ThemeContext is used to set the CSS class for changing the color based on the theme',
        link: null,
      },
    ],
  ...
  storybook: {
    ...
    text: [
      ...
      {
        text: 'You can view one component at a time instead of viewing your whole app',
        link: null,
      },
      {
        text: "Using 'knobs', you can manipulate the conditions the component is under so you can see it in all states",
        link: null,
      },
      {
      ...
      {
        text: 'Run `npx -p @storybook/cli sb init --type react_scripts` to install, and `npm run storybook` to start',
        link: null,
      },
    ],
    title: 'Storybook',
  ...
  debugging: {
    ...
    text: [
      ...
      {
        text: 'Use React Developer Tools to track the props and state of components',
        link: null,
      },
      {
        text:
  ...
  testing: {
    ...
    photos: [{alt: 'Screenshot of Jest test running and passing', photo: jest}],
    text: [
      {
        text: 'Jest is a JavaScript testing framework used for writing unit tests',
        link: 'https://jestjs.io/',
      },
      {
        text: 'Make snapshots of components to track if changes update how your components render',
        link: null,
      },
      {
        text: 'It allows you to mock modules so you can control how code executes.',
        link: null,
      },
    ],
    title: 'Testing',
  ...
  typescript: {
    ...
    text: [
      {
        text: 'TypeScript (TS) is a typed superset of JavaScript that compiles to plain JavaScript.',
      ...
      {
        text: 'It can have a learning curve, but is thought to be worth it in exchange for reducing bugs.',
        link: null,
      },
    ],
    title: 'TypeScript',
  ...
  next_steps: {
    ...
    photos: [{alt: 'Screenshot of React Documentation page', photo: react_docs}],
    text: [
      {
      ...
      {
        text: "Create React App: It generates a 'Hello World' React app with a single command",
